...
(1, 'Raskin Pandey', 'admin@gmail.com', 'admin123');
...
CREATE TABLE `course` (
  ...
  `course_tags` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
INSERT INTO `course` (`course_id`, `cid`, `course_name`, `course_desc`, `course_author`, `course_img`, `course_duration`, `course_price`, `course_original_price`, `course_tags`) VALUES
(9, 11, 'Complete PHP Bootcamp', 'This course will help you get all the Object Oriented PHP, MYSQLi and ending the course by building a CMS system.', 'Rajesh Kumar', '../image/courseimg/php.jpg', '3 Months', 700, 1700, 'php, laravel, ruby'),
(10, 1, 'Learn Python A-Z', 'This is the most comprehensive, yet straight-forward, course for the Python programming language.', 'Rahul Kumar', '../image/courseimg/Python.jpg', '4 Months', 800, 1800, 'python, pycharm, pandas, machine learning'),
(11, 14, 'Hands-on Artificial Intelligence', 'Learn and Master how AI works and how it is changing our lives in this Course.\r\nlives in this Course.', 'Jay Veeru', '../image/courseimg/ai.jpg', '6 Months', 900, 1900, 'AI, Machine learning, Artificial Intelligence'),
(12, 15, 'Learn Vue JS', 'The skills you will learn from this course is applicable to the real world, so you can go ahead and build similar app.', 'Jay Shukla', '../image/courseimg/vue.jpg', '2 Months', 100, 1000, 'JavaScript, javascript, vue, next'),
(13, 15, 'Angular JS', 'Angular is one of the most popular frameworks for building client apps with HTML, CSS and TypeScript.', 'Sonam Gupta', '../image/courseimg/angular.jpg', '4 Month', 800, 1600, ''),
(16, 1, 'Python Complete', 'This is complete Python COurse', 'RK', '../image/courseimg/Python.jpg', '4 hours', 500, 4000, ''),
(17, 15, 'Learn React Native', 'THis is react native for android and iso app development', 'GeekyShows', '../image/courseimg/Machine.jpg', '2 months', 200, 3000, '');
...
(14, 'This course is helping me a lot in making my career as a web developer.', 183);
...
(183, '  ram', 'ram@gmail.com', 'ram123', '  ', '../image/stu/student1.jpg'),
(184, 'shyam', 'shyam@gmail.com', 'shyam123', '', '');
