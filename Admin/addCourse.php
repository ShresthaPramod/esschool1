...
include('../dbConnection.php');
 ...
 if(isset($_REQUEST['courseSubmitBtn'])){
  ...
  if(($_REQUEST['course_name'] == "") || ($_REQUEST['course_desc'] == "") || ($_REQUEST['course_author'] == "") || ($_REQUEST['course_duration'] == "") || ($_REQUEST['course_price'] == "") || ($_REQUEST['course_original_price'] == "")|| ($_REQUEST['course_tags'] == "")){
   ...
   $course_tags=  $_REQUEST['course_tags'];
   $course_image = $_FILES['course_img']['name']; 
   $course_image_temp = $_FILES['course_img']['tmp_name'];
   $img_folder = '../image/courseimg/'. $course_image; 
   move_uploaded_file($course_image_temp, $img_folder);
    $sql = "INSERT INTO course (cid,course_name, course_desc, course_author, course_img, course_duration, course_price, course_original_price, course_tags) VALUES ('$category','$course_name', '$course_desc','$course_author', '$img_folder', '$course_duration', '$course_price', '$course_original_price','$course_tags')";
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <select id="form3Examplea4" name="category" class="form-control form-control-lg" required>
                ...
                <option name="<?php echo $row['cName']; ?>" value="<?php echo $row['cid']; ?>">
